...
LATEST_VERSION = requests.get(url="https://github.com/201710396").json()['version']
...
class MainWindow(QMainWindow):
    ...
    def showProgInfo(self):
        infoBox = QMessageBox()
        infoBox.information(self, "정보", "제작자 : 김진혁<br>깃허브 : <a href='https://github.com/201710396'>https://github.com/201710396</a><br>이메일 : 201710396@office.seowon.ac.kr")
    ...
    def initToolbar(self):
        ...
        """)
        brushTool = QAction(QIcon(resourcePath("dependencies/image/brush.png")), "브러시", self)
        brushTool.triggered.connect(self.brushMode)
        eraserTool = QAction(QIcon(resourcePath("dependencies/image/eraser.png")), "지우개", self)
        rectTool = QAction(QIcon(resourcePath("dependencies/image/rect.png")), "사각형", self)
        rectTool.triggered.connect(self.rectMode)
        ellipseTool = QAction(QIcon(resourcePath("dependencies/image/ellipse.png")), "타원형", self)
        ellipseTool.triggered.connect(self.ellipseMode)
        lineTool = QAction(QIcon(resourcePath("dependencies/image/line.png")), "선", self)
        lineTool.triggered.connect(self.lineMode)
        textTool = QAction(QIcon(resourcePath("dependencies/image/text.png")), "텍스트", self)
...
class GraphicsView(QGraphicsView):
    ...
    def changeAttribute(self, dict, cbx):
        try:
            ...
            if type(obj) == type(QGraphicsLineItem()) or type(obj) == type(QGraphicsTextItem()):
